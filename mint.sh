...
sudo qemu-system-x86_64 -cdrom linuxmint-20.3-cinnamon-64bit.iso -vnc :0 -hda win10.vdi -smp cores=8  -m 12000M -machine usb=on -device usb-tablet > /dev/null 2>&1